...
impl ShowData {
    pub fn from_showfile(showfile: &Showfile) -> Result<Self, server::Error> {
        build_from_showfile(showfile)
    }
}

fn build_from_showfile(showfile: &Showfile) -> Result<ShowData, server::Error> {
